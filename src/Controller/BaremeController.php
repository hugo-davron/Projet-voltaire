...
class BaremeController extends AbstractController
{
    ...
    public function verifybareme()
    {
    	...
    	if((strcmp($_GET['1param52'],"") == 0) || (strcmp($_GET['2param52'],"") == 0) || (strcmp($_GET['3param52'],"") == 0)){
    		...
    		($_GET['3param11'] < $_GET['3param12']) || ($_GET['3param12'] <= $_GET['3param21']) || ($_GET['3param21'] < $_GET['3param22']) || ($_GET['3param22'] <= $_GET['3param31']) || ($_GET['3param31'] < $_GET['3param32']) ||($_GET['3param32'] <= $_GET['3param41']) || ($_GET['3param41'] < $_GET['3param42']) || ($_GET['3param42'] <= $_GET['3param51'])){
                ...
                $message = "Il semble que vous n'ayez pas donné des intervalles fermées (On ne peux pas attribuer 1 point pour 2-4 points et 2 points pour 5-7 points!) <a href= 'http://webinfo.iutmontp.univ-montp2.fr/~davronh/pvoltaire.old/public/index.php/bareme/creerbareme'> Recreer un bareme ! </a>";
                }else{
            ...
            $message3 = $messages[1];
                ...
                $message = "Il semble qu'il y ait une incohérence pour les intervalles (le deuxieme intervale doit toujours être supérieur au premier). <a href= 'http://webinfo.iutmontp.univ-montp2.fr/~davronh/pvoltaire.old/public/index.php/bareme/creerbareme'> Recreer un bareme ! </a>";
            }
    	}
    	elseif((strcmp($_GET['1param12'],"") == 0) || (strcmp($_GET['1param22'],"") == 0) || (strcmp($_GET['1param32'],"") == 0) || (strcmp($_GET['1param42'],"") == 0)  ||
    		...
    		$message = "L'une des intervalles de début est nulle ! (Vous pouvez laisser uniquement que la derniere intervalle d'un critère vide ) <a href= 'http://webinfo.iutmontp.univ-montp2.fr/~davronh/pvoltaire.old/public/index.php/bareme/creerbareme'> Recreer un bareme ! </a>";}	
    	elseif( !($_GET['1param11'] < $_GET['1param12']) || !($_GET['1param12'] <= $_GET['1param21']) || !($_GET['1param21'] < $_GET['1param22']) || !($_GET['1param22'] <= $_GET['1param31']) || !($_GET['1param31'] < $_GET['1param32']) ||!($_GET['1param32'] <= $_GET['1param41']) || !($_GET['1param41'] < $_GET['1param42']) || !($_GET['1param42'] <= $_GET['1param51']) || !($_GET['1param51'] < $_GET['1param52']) || 
    		...
    		$message = "Il y a un problème avec l'attribution des critères, avez vous bien vérifié que tous les criteres sont dans l'ordre croissant?  <a href= 'http://webinfo.iutmontp.univ-montp2.fr/~davronh/pvoltaire.old/public/index.php/bareme/creerbareme'> Recreer un bareme ! </a>";
    	}	
    	else{
    		$message = "Bareme verifié !";
    		$messages = BaremeController::verifiedbareme();
    ...
    public function validerBareme(){ 
    	if(isset($_GET['favori'])){$favori = 1;}
            ...
            try { 
                $entityManager->flush();
                return "Bareme validé ! <a href= \"http://webinfo.iutmontp.univ-montp2.fr/~davronh/pvoltaire.old/public/index.php/etudiant\" > Retourner sur la page d'accueil </a>";
            }
            catch(Exception $e){
                return "Ce bareme a deja ete cree !";
            }
